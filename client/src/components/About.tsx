    ...
    <div className="landing__about">
      ...
      <section className="landing__about--content">
        ...
        <div className="landing__about--card">
          ...
          <p className="landing__about--card--right">The Socket.io maestro, he created almost all the back end and implemented our video and whiteboard with Socket.io and Google Maps integration.</p>
        </div>
        ...
        <div className="landing__about--card">
          ...
          <p className="landing__about--card--right">A front end guru, he created most of the other pages on the front end and added the Stripe payment</p>
        </div> 
      </section>
    </div>
  )
